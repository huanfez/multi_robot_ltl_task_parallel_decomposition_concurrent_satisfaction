...
public class ComptExperiment_centralized_Z1_Robot4 {
...
//		tsGraph.addEdge(nodet, nodep, new TSEdge("P"));
	...
	public static void main(String args[]) throws ExportException, IOException {
		...
		ArrayList<String> initNode1 = new ArrayList<String>(Arrays.asList("h"));
		Robot robot1 = new Robot(buildRobotActionList(1), buildTsGraph(1), initNode1);
		
		ArrayList<String> initNode2 = new ArrayList<String>(Arrays.asList("j"));
		Robot robot2 = new Robot(buildRobotActionList(2), buildTsGraph(2), initNode2);
		
		ArrayList<String> initNode3 = new ArrayList<String>(Arrays.asList("m"));
		Robot robot3 = new Robot(buildRobotActionList(3), buildTsGraph(3), initNode3);
		
		ArrayList<String> initNode4 = new ArrayList<String>(Arrays.asList("i"));
		Robot robot4 = new Robot(buildRobotActionList(4), buildTsGraph(4), initNode4);
		
		ArrayList<String> initNode5 = new ArrayList<String>(Arrays.asList("n"));
		Robot robot5 = new Robot(buildRobotActionList(5), buildTsGraph(5), initNode5);
		Set<Robot> providedRobots0 = new HashSet<>(Arrays.asList(robot0, robot1, robot2, robot3));
...
//		RegExp regExpr_2 = new RegExp("(j((ntg)|(tng)|(tgn)))|(t((gjn)|(jng)|(jgn)))");
		Automaton globalTaskAutomaton = regExpr_1.toAutomaton();
...
//		}
		...
		for (int index = 0; index < 1; index++) {
			...
			robotSetSwitchManned.autRobotsPair.add(
					new RobotConfig(new TaskAutomaton(globalTaskAutomaton), providedRobots0));
