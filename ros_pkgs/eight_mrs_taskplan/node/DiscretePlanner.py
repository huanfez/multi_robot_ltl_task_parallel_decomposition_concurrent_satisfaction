...
currentDir = '/home/hz/catkin_ws/src/eight_mrs_taskplan/node/'
...
#                self.goals = self.goal_list
            ...
            currentNuSMVDir = currentDir + 'NuSMV-2.6.0-Linux/bin/'
            output = subprocess.check_output(currentNuSMVDir + 'NuSMV ' + currentDir + 'inNuSMV_agent{}.smv'.format(self.agent_num), shell=True, universal_newlines=True)
            ...
            for lines in paths:
                if 'x.state_order' in lines and not goal_written:
                    self.state_order.append(lines[20:].strip())
