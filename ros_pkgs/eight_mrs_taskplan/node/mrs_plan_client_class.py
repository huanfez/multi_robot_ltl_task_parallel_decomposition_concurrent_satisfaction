...
keph4_task_client = actionlib.SimpleActionClient('kephera4task', TaskAction)
keph5_task_client = actionlib.SimpleActionClient('kephera5task', TaskAction)
keph6_task_client = actionlib.SimpleActionClient('kephera6task', TaskAction)
keph7_task_client = actionlib.SimpleActionClient('kephera7task', TaskAction)
# ######################################################
kephera_clients = [keph0_task_client, keph1_task_client, keph2_task_client, keph3_task_client, \
                   keph4_task_client, keph5_task_client, keph6_task_client, keph7_task_client]
