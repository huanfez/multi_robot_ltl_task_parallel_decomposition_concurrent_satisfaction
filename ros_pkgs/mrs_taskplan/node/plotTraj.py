...
traj2_d_x, traj2_d_y = np.loadtxt(currentDir + 'traj2d.txt' , delimiter = ' ', unpack = True)
...
traj3_d_x, traj3_d_y = np.loadtxt(currentDir + 'traj3d.txt' , delimiter = ' ', unpack = True)
#plt.plot(traj3_a_x, traj3_a_y, 'r:', label = 'actual')
plt.plot(traj3_d_x, traj3_d_y, 'r:', label = 'desired')

#with warnings.catch_warnings():
#  warnings.simplefilter("ignore")
#  traj4_a_x, traj4_a_y = np.loadtxt(currentDir + 'traj4_a.txt' , delimiter = ' ', unpack = True)
traj4_d_x, traj4_d_y = np.loadtxt(currentDir + 'traj4d.txt' , delimiter = ' ', unpack = True)
#plt.plot(traj4_a_x, traj4_a_y, 'r:', label = 'actual')
plt.plot(traj4_d_x, traj4_d_y, 'g:', label = 'desired')
