...
#####################################################
tasklist1 = [('a', 'epslion'), ('b', 'epslion'), ('c', 'epslion')]
...
# Experiment 2
tasklist2 = [('c', 'f'), ('g', 'g')]
transList2 = [Transition('f', [3]), Transition('g', [3]), Transition('g', [1])]
robotlist2 = (1,3)
subeventList2 = [['f', 'g']]
taskplan2 = Taskplan(tasklist2, transList2, robotlist2, 0, subeventList1, 1)
